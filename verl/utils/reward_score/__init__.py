...
def default_compute_score(data_source, solution_str, ground_truth, extra_info=None, sandbox_fusion_url=None, concurrent_semaphore=None, reward_model_clients=None):
    ...
    elif data_source in ["lighteval/MATH", "DigitalLearningGmbH/MATH-lighteval", "deepscale-r-preview"]:
        from . import math
    ...
    elif data_source in ["passrate-math"]:
        from . import compassverifier
        question = extra_info["question"]

        res = compassverifier.compute_score(question, ground_truth, solution_str, reward_model_clients)
    else:
