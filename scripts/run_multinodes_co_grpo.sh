...
# verifier related
verifier_lora_rank=16
verifier_lora_alpha=32
verifier_lora_dropout=0.1
verifier_lr=1e-5
verifier_loss_weight=1.0
verifier_lora_path=""  # Path to pretrained verifier LoRA, empty to train from scratch
