...
# Apply vLLM Qwen3 fix at runtime
python3 -c "
import sys
...
echo "==================== DEBUG CONFIG ===================="
echo "REWARD_MODEL_URLS = $REWARD_MODEL_URLS"
echo "REWARD_MODEL_KEY = $REWARD_MODEL_KEY"
echo "======================================================"
...
# ========== MINI DEBUG: 极小batch size ==========
response_n=2        # 每个prompt只生成2个response
train_batch_size=2  # batch size只有2
...
num_generation_per_prompt=2  # Mini debug: 每个prompt生成2个
...
exp_name=$(basename "$model")_${train_file_name}_bs${train_batch_size}_n${response_n}_${intervention_mode_short}_${timestamp}
...
LOG_FILE=/mnt/shared-storage-user/liuhongwei/main_works/temp_debug/logs/mini_debug_${timestamp}.txt
...
echo "==================== STARTING MINI DEBUG TRAINING ===================="
echo "train_batch_size = $train_batch_size"
echo "response_n = $response_n"
echo "num_generation_per_prompt = $num_generation_per_prompt"
echo "======================================================================="
